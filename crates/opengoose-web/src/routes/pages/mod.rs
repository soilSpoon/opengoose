...
use catalog::{
    agents, plugin_action, plugins, queue, runs, schedule_action, schedules, sessions,
    sessions_events, team_save, teams, trigger_action, trigger_workflow_action, triggers,
    workflows,
};
...
pub(crate) mod test_support {
    pub(crate) use super::catalog::test_support::{
        ...
        render_schedules_page, render_session_detail, render_sessions_page, render_workflow_detail,
