...
pub(super) fn with_pages_home(test: impl FnOnce()) {
    with_temp_home("opengoose-routes-pages-home", test);
}
...
pub(super) fn session_key(channel: &str) -> SessionKey {
    SessionKey::new(Platform::Discord, "ops", channel)
}
